...
public class DepartmentLogin extends JFrame {
    private JTextField usernameField;
    private JPasswordField passwordField;
    private JButton loginBtn, backBtn;

    public DepartmentLogin() {
        setTitle("Department Login");
        ...
        JLabel titleLabel = new JLabel("Department Login");
        ...
        loginBtn.addActionListener(e -> {
            ...
            try (Connection conn = DBConnection.getConnection()) {
                String sql = "SELECT dept_id FROM departments WHERE username=? AND password=?";
                ...
                if (rs.next()) {
                    ...
                    dispose();
                    new DepartmentDashboard(deptId);
                } else {
